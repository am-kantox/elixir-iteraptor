defmodule Property.Iteraptor.Test do
  ...
  defmacrop leaf_map_set,
    do: quote do: StreamData.bind(list_of(aib()), fn list -> StreamData.constant(MapSet.new(list)) end)
  ...
  defmacrop non_leaf_map_set,
    do: quote do: StreamData.bind(list_of(leaf()), fn list -> StreamData.constant(MapSet.new(list)) end)
  defmacrop non_leaf_keyword, do: quote do: keyword_of(leaf())
  defmacrop non_leaf,
    do: quote do: one_of([non_leaf_list(), non_leaf_map(), non_leaf_map_set(), non_leaf_keyword()])
  ...
  defmacrop maybe_leaf_map_set,
    do: quote do: StreamData.bind(list_of(one_of([leaf(), non_leaf()])), fn list -> StreamData.constant(MapSet.new(list)) end)
  defmacrop maybe_leaf_keyword,
    do: quote do: keyword_of(one_of([leaf(), non_leaf()]))
  defmacrop maybe_leaf,
    do: quote do: one_of([maybe_leaf_list(), maybe_leaf_map(), maybe_leaf_map_set(), maybe_leaf_keyword()])
